...
In this session, we will focus on the *New project, GitHub first* approach.
...
In the next two sessions, we will into a solution for making your research reproducible for everybody: "One-click reproducibility" using *Jupyter Notebooks* and *Binder*
