...
.small[
- Senior researcher in the team *Data Augmentation* in the department [*Survey Data Curation*](https://www.gesis.org/en/institute/departments/survey-data-curation) at *GESIS*
    - digital trace data for social science research
    - data linking (surveys + digital trace data) 
    
- (Co-) Team leader of the team *Research Data & Methods* at the [*Center for Advanced Internet Studies* (CAIS)](https://www.cais-research.de/)
...
- A version of [`R`](https://www.r-project.org/) that is >= 4.0.0
  - the following `R` packages: `tidyverse`, `rmarkdown`, `usethis`
...
```{r lazy-tweet, echo=FALSE, out.width="60%"}
