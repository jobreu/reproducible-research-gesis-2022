...
```{r rmd-formats, out.width ="65%", echo=FALSE}
woRkshoptools::include_picture("./rmarkdown_formats.png")
```
...
Apart from being synthetic, the data we use here differ from the original data set in two ways: They only include numeric variables (and no value or variable labels), and all values < 0 have been recoded as `NA`. You can find this file in the `data` folder within the workshop materials.
